...
if language == 'en':
	...
	instructions_text4a = visual.TextStim(win, text='In some trials it\'s not clear on which side points were missing.',
										height = fontsize,
										font = 'Arial',
										color = 'white',
										alignHoriz = 'center',
	...
	instructions_text5a = visual.TextStim(win, text='Press the "%s" key if you are unsure on which side something was missing.'%(go_side),
										font = 'Arial',
										height = fontsize,
										color = 'white',
										alignHoriz = 'center',
	...
	instructions_text4a = visual.TextStim(win, text='In einigen Durchgängen ist es nicht klar, auf welcher Seite etwas fehlt.',
										height = fontsize,
										font = 'Arial',
										color = 'white',
										alignHoriz = 'center',
	...
	instructions_text5a = visual.TextStim(win, text='Drücke die "%s" Taste, wenn du dir unsicher bist, auf welcher Seite etwas gefehlt hat.'%(go_side_de),
										font = 'Arial',
										height = fontsize,
										color = 'white',
										alignHoriz = 'center',
...
instructions_text4a.wrapWidth = wrapwidth
instructions_text5.wrapWidth = wrapwidth
instructions_text5a.wrapWidth = wrapwidth
...
for b in range(len(block_list)):
	...
	trial_list_block = pd.read_csv(filepath_or_buffer = "trials/no_go_run"+run+"-00"+str(block_list[b])+".par",
