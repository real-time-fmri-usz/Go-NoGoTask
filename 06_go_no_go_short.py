...
stim_dur = {'strong':1,'weak':6,'catch':0}     # time in seconds that the subliminal stim appears on the screen [strong,weak,catch]
blank_dur = {'strong':2,'weak':2,'catch':0}        # time a blank screen between stim and mask is on screen [strong,weak,catch]
mask_dur = {'strong':12,'weak': 7,'catch':15}     # time the mask appears on the screen [strong,weak,catch]
...
output_file_path = 'results/%s_%s_%s_%s_%s_training.csv'%(subid,run,stimulus_strength,go_side,time_stamp)
